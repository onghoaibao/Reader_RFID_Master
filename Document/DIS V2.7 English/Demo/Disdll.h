...
APP_DLL int   _stdcall  ReadSingleTag(unsigned char& usercode,  unsigned char* pTagID, unsigned char* pAntNo);
/*------------------------------------------------------------------------------- 
	1、名称:  ReadSingleTag
	2、功能:  读单张标签
	3、参数:  
...
APP_DLL bool   _stdcall  WriteEpcByAnt(unsigned char usercode, unsigned char bank, unsigned char begin,int length,unsigned char ant,unsigned char mode,const unsigned char* pData);
/*------------------------------------------------------------------------------- 
...
APP_DLL bool   _stdcall  ReadEpcByAnt(unsigned char usercode, unsigned char bank, unsigned char stardAdd,int len,unsigned char ant, unsigned char* pData);
/*------------------------------------------------------------------------------- 
	1、名称: ReadTIDByEpc
	2、功能: 根据EPC读TID
	3、参数
...
//非接口函数
bool DisCheckValue(BYTE* Data,int start,int len,BYTE value);
#endif  // _DISDLL_H